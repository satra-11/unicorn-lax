    ...
    <div v-if="isOpen" class="fixed inset-0 z-[9999] flex items-center justify-center p-4">
      ...
      >
        ...
        <div class="p-6 space-y-6">
            <!-- Model Selection -->
            <div>
                <h3 class="text-sm font-semibold text-gray-900 mb-2">顔検出モデル (Face Detection Model)</h3>
                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div 
                        ...
                        :class="faceModel === 'ssd' ? 'border-blue-500 ring-1 ring-blue-500 bg-blue-50/50' : 'border-gray-200'"
                    >
                        <div class="mt-0.5">
                            ...
                            >
                                <div v-if="faceModel === 'ssd'" class="w-2.5 h-2.5 rounded-full bg-blue-600"></div>
                            </div>
                        </div>
                        <div>
                    ...
                    <div 
                        ...
                        class="relative border rounded-lg p-4 cursor-pointer transition-all hover:bg-gray-50 flex items-start gap-3"
                        :class="faceModel === 'tiny' ? 'border-blue-500 ring-1 ring-blue-500 bg-blue-50/50' : 'border-gray-200'"
                    >
                         <div class="mt-0.5">
                            <div class="w-4 h-4 rounded-full border border-gray-400 flex items-center justify-center"
                                :class="{'border-blue-600': faceModel === 'tiny'}"
                            >
                                <div v-if="faceModel === 'tiny'" class="w-2.5 h-2.5 rounded-full bg-blue-600"></div>
                            </div>
                        </div>
                        <div>
